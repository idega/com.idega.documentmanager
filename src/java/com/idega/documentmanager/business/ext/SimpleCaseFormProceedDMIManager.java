 ...
 */
public class SimpleCaseFormProceedDMIManager implements DocumentMetaInformationManager {
	...
	public void update(Object metaInf) {
		...
		if(metaInf != null && !(metaInf instanceof SimpleCaseFormProceedMetaInf))
			throw new IllegalArgumentException("Wrong meta inf argument provided. Should be of class: "+SimpleCaseFormProceedMetaInf.class.getName()+", but got: "+metaInf.getClass().getName());
